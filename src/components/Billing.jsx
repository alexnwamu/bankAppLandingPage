    ...
    <section id='product' className={layout.sectionReverse}>
      <div className={layout.sectionImgReverse}>
        ...
        <div className={layout.sectionInfo}>
          ...
          <div className={`flex flex-row flex-wrap sm:mt-10 mt-6 `}><img src={apple}  className='w-[128px] h-[42px] mr-5 object-contain' alt="apple" /> <img src={google} className='w-[144px] h-[43px] object-contain'  alt="" /></div>
